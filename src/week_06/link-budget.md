...
4. This calculator assumes clean, linear dB math with no amplification. OTN's long-haul DWDM links (a stretch topic later in the program) cover distances where fiber loss alone would exceed any transmitter's launch power by 10-20x. What does that tell you about what a long-haul link has to add that this calculator doesn't model?
