...
No ContainerLab topology this week: optics and high-speed signaling aren't really things a Linux container can simulate. Instead there's one interactive code lab that makes the physical-layer math from this week's [Objectives](./objectives) concrete.
